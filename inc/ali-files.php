...
function my_css_calling(){ 
    wp_register_style('owlcarousel', get_template_directory_uri().'/libraries/owlcarousel/assets/owl.carousel.css', array(), '2.3.4', 'all' ); 
    ...
    wp_enqueue_script('owlcarousel', get_template_directory_uri() .'/libraries/owlcarousel/owl.carousel.js', array(), '2.3.4', 'true' );
