...
$gatewayEnabled = get_option('ENABLE_PAYMENT_GATEWAY');
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <?php if ($invoiceNumber >= '6') { ?>
                                            <div class="card">
                                                ...
                                                <br />
                                                <p>You may pay Great America lease invoices online <a href="https://www.accountservicing.com/payment">Here</a>.</p>
