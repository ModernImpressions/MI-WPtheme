                    ...
                    <div class="content">
                        ...
                        ?>
                            ...
                            <?php } elseif ($browser == 'Other') { ?>
                                ...
                                <p>If your download does not start automatically after a few seconds, you can click <a href="https://get.teamviewer.com/<?php echo $teamViewerSlug ?>">HERE</a> to be taken to
                        ...
                        <div>
                            ...
                            <ul>
                                <li><?php if ($os == 'Chrome OS') { ?>
                                        ...
                                        <?php } elseif ($os == 'Other') { ?>Visit the <a href="https://get.teamviewer.com/<?php echo $teamViewerSlug ?>">TeamViewer</a>
                                        page to see if your device supports the
                                        program.<?php } elseif ($os == 'Windows' || $os == 'Mac') { ?><a onclick="downloadTeamViewer()">TeamViewer</a><?php } ?> *Windows/Mac Support
                                </li>
