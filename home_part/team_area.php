        <section id="team_area">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php query_posts('post_type=team_area&post_status=publish&posts_per_page=-1&meta_key=department,display_order&orderby=meta_value&order=ASC&paged='. get_query_var('post')); ?>
                    <?php if(have_posts()) : ?>
