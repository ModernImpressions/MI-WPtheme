            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <?php echo do_shortcode('[su_youtube_advanced url="https://www.youtube.com/watch?v=USgOhNJGxjs" width="420" height="280" loop="1" controls="alt" autohide="yes" modestbranding="yes" wmode="transparent" playsinline="yes" title="An Introduction to Modern Impressions"]'); ?>
                        <?php else : ?>
                        <?php endif;
                        endif; ?>
                    </div>
