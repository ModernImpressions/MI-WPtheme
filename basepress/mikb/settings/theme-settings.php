							...
							<tbody>
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Go to fonts.google.com, choose the font you like with a regular and bold size. Paste here the @import code for the font you chose.<br>Leave empty to inherit the font family from the website theme.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Insert the size in pixels for the knowledge base font.<br>Leave empty to inherit size from the website theme.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Default is <b>Knowledge Base</b>.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'This will force the header to stretch over website container and take full window width.<br> Will also set the body overflow-x to hidden.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Insert the top offset value including unit( px, %, em etc.) to properly distance the header from the top of the page.<br>You can use positive and negative values.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'If activated the sidebar will remain fixed in the page while scrolling.', 'basepress' ); ?></p>
									</td>
								</tr>
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Distance from top of screen including unit( px, %, em etc.) before sidebar becomes sticky.', 'basepress' ); ?></p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="setting-control">
										...
										<p class="description"><?php _e( 'Enable this to apply the custom colors below.', 'basepress' ); ?></p>
									</td>
								</tr>
